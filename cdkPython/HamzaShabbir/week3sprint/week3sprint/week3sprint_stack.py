...
class Week3SprintStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        #creting metrics for Lambda Itslef Such as DUration, Memory Etc.
        duration_metric=hw_lambda.metric('Duration')
        #Now Creating Alarms based on Duration
        duration_Alarm=cloudwatch_.Alarm(self,'Duration Alarm',threshold=1800,
        comparison_operator=cloudwatch_.ComparisonOperator.GREATER_THAN_THRESHOLD,metric= duration_metric,
        evaluation_periods=1 )

        #Adding CLoud WAtch Alarm Actions 
        duration_Alarm.add_alarm_action(cw_actions_.SnsAction(mytopic))
        #Cretting Alias 
        ...
        deployment_group = codedeploy_.LambdaDeploymentGroup(self, "BlueGreenDeploymentHamza",alarms=[duration_Alarm],
        alias=alias,
